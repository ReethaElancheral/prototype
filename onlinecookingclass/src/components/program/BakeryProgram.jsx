...
// import bannerImg from "../../assets/images/ourstoryimg.png";
...
//   {
//     icon: icon2,
//     text: "Author 50+ Books",
//   },
//   {
//     icon: icon3,
//     text: "30 Years+ Culinary expertise",
//   },
// ];

// const BakeryProgram = () => {
//   return (
//     <section className="bg-[#fff6ed] pt-20 pb-32 px-4 flex justify-center items-center relative z-0">
//       <div className="max-w-7xl w-full relative">
//         {/* Main Bakery Banner */}
//         <div
//           className="relative bg-cover bg-center rounded-3xl overflow-hidden h-[600px] shadow-xl"
//           style={{ backgroundImage: `url(${bannerImg})` }}
//         >
//           {/* Text Overlay - Perfect Center-Left */}
//           <div className="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center pl-12 pr-[200px] text-white">
//             <div className="space-y-3 max-w-xl">
//               <h2 className="text-lg font-semibold uppercase text-yellow-300">
...
//                 <li>Batch Start Date – 25th July 2025</li>
//                 <li>8-Week Online Pre-Recorded Video Content</li>
...
//           {/* Chef Image - Bigger and Vertically Centered on Right */}
//           <img
//             src={chefImg}
//             alt="Chef"
//             className="absolute top-1/2 right-14 transform -translate-y-1/2 w-[400px] h-[400px] object-cover rounded-full border-4 border-white shadow-2xl z-10"
//           />
//         </div>

//         {/* Sub Cards - Overlapping Bottom Half-in-Half-out */}
//         <div className="absolute w-full left-1/2 transform -translate-x-1/2 translate-y-1/2 bottom-0 px-6 md:px-16 z-20 ">
//           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
//             {featureCards.map((card, index) => (
//               <div
//                 key={index}
//                 className="bg-[#fff6ed] rounded-2xl shadow-xl p-4 flex items-center space-x-4"
//               >
//                 <img
//                   src={card.icon}
//                   alt={`icon-${index}`}
...
//                 />
//                 <p className="text-md font-medium text-black">{card.text}</p>
//               </div>
//             ))}
//           </div>
//         </div>
...
export default function BakeryProgram() {
