...
import bmsserviceImg from '../../assets/images/serviceshero.png';
import bmsImg from '../../assets/images/bms.png';
import lightningIcon from "../../assets/images/boltsymbol.png";

export default function BmsOurServices() {
  ...
  return (
    <section className="relative py-16 px-6 md:px-20">
      ...
      <div className="relative max-w-4xl mx-auto overflow-hidden rounded-xl">
        <img src={bmsserviceImg} alt="CCTV Service" className="w-full object-cover" />
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-start px-8 md:px-16 text-white space-y-4">
          ...
          >
             <div className="flex items-center mb-4 gap-4">
                                         <img src={bmsImg} alt="Mission Icon" className="w-16 h-16" />
        ...
        BMS
          ...
          {/* Description */}
          <p
            className={`max-w-xl font-semibold opacity-0 transform translate-x-[-20px] transition-all duration-700 ${
