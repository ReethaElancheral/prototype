...
const OnlineTraineesPage = () => {
  ...
  useEffect(() => {
    const stored = localStorage.getItem("traineesOnline");
  ...
  const addTrainee = (e) => {
    e.preventDefault();
    const newTrainee = { ...formData, image: "/assets/img5.png" };
    const updatedList = [...trainees, newTrainee];
    setTrainees(updatedList);
    localStorage.setItem("traineesOnline", JSON.stringify(updatedList));
    setShowModal(false);
    setFormData({
      name: "",
      duration: "",
  ...
  return (
    <div className="home-container">
      ...
      <div className="main-content">
        <h2>Trainer Name &gt; Online Trainees</h2>

        <button className="btn-primary btnonline" onClick={() => setShowModal(true)}>
          + Add Trainee
        </button>
...
export default OnlineTraineesPage;
